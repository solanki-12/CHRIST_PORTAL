		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<li class="nav-item" id="report">
					<a class="nav-link active" aria-current="page" style="margin-left:-44%;" href="Report.html">Report</a>
				</li>
				<li class="nav-item" id="mprofile">
					<a class="nav-link active" aria-current="page" style="margin-left:-84%;" href="Myprofile.jsp">My Profile</a>
				</li>
...
<form method="POST" action="otpConfirmation.jsp">
<div>
...
<img src="2x/imagephoto.png" class="logo" style= "margin-left: 27%; margin-top: -70px; width: 44px; height: 43px;">
	...
	width: 325px; margin-left: 34%; margin-top: 7px;" value="<%=namedb%>" >
	...
	<button type="button" class="btn btn-primary" style="margin-left: 92%; margin-top: -9%;" disabled>Edit</button>
	</div>
	</div>
	...
	<div class="col-md-6">
	<input type="password"  class="form-control" placeholder="Password" id="password" name="password" style="width: 78%; margin-left: 72%; margin-top:6%;" value="<%=passwordb%>" >
