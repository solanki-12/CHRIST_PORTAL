		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<li class="nav-item dropdown">
					...
					<a class="nav-link dropdown-toggle" class="nav-link active" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
						Assignment
					</a>
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						<li><a class="dropdown-item" href="AssignmentCreate.jsp">Create Assignment</a></li>
						<li><hr class="dropdown-divider"></li>
						<li><a class="dropdown-item"  class="nav-link active" href="ModifyAssgn.jsp">Modify Assignment</a></li>
					</ul>
				</li>
...
<div class="container" >
<form  method="POST" action="ModifyAssgn.jsp" style="margin-left: 85px;">
    <br><br><br>
    <label style="font-size:40px;margin-left:30%;" class="modify"> <b>Modify Assignment</b></label><br><br><br>
...
while(rs.next())
{
	    ...
	    %>
	      ...
	      <td><a href="ModifyEdit.jsp?Number=<%=rs.getString("assignment_no")%>">Edit</a></td>
	       <td><a href="DeleteAssgn.jsp?Number=<%=rs.getString("assignment_no")%>">Delete</a></td>
